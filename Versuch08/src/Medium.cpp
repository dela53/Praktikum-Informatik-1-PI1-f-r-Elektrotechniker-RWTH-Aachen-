...
std::ostream& operator<<(std::ostream& out, const Medium& medium) // Überladener Ausgabe-Operator
                                                                  // Referenz für Medium wird hier übergeben damit die Funktion hier auf Medium zugreifen kann.
{
	medium.ausgabe(out);
	return out;
}
